...
class MenuLayout 
    ...
    # @builder            -> Variable contenant le GTK Builder pour donner forme aux menus
    # @menu               -> Variable contenant la fenetre du menu en cours
    # @btn_retour         -> Variable contenant le bouton de retour
    # @css_file           -> Fichier contenant toutes les caractéristiques CSS
    # @btn_facile         -> Zone contenant les boutons faciles
    # @btn_moyen          -> Zone contenant les boutons moyens
    # @btn_difficile      -> Zone contenant les boutons difficiles
    # @tabfacile          -> Tableau contenant les paths des niveaux faciles
    # @tabdimfacile       -> Tableau contenant les dimensions des niveaux faciles
    # @tabmoyen           -> Tableau contenant les paths des niveaux moyens
    # @tabdimmoyen        -> Tableau contenant les dimensions des niveaux moyens
    # @tabdifficile       -> Tableau contenant les paths des niveaux difficiles
    # @tabdimdifficile    -> Tableau contenant les dimensions des niveaux difficiles
    # @tableauBtn         -> Tableau contenant la liste de tous les boutons
