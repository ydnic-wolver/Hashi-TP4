...
class ClassementDifficile < Gtk::Window
	...
	btnNiveau1.signal_connect('clicked'){
		...
		classement = ClassementNiveau.new("Classement/Difficile/classement10x7.txt")
	...
	btnNiveau5.signal_connect('clicked'){
		self.set_sensitive(false)
		classement = ClassementNiveau.new("Classement/Facile/classement15x15_1.txt")
		self.set_sensitive(true)
	}
	btnNiveau6 = Gtk::Button.new(:label => 'Niveau 6')
	btnNiveau6.signal_connect('clicked'){
		self.set_sensitive(false)
		classement = ClassementNiveau.new("Classement/Facile/classement15x15_2.txt")
		self.set_sensitive(true)
	}
	btnNiveau7 = Gtk::Button.new(:label => 'Niveau 7')
	btnNiveau7.signal_connect('clicked'){
		self.set_sensitive(false)
		classement = ClassementNiveau.new("Classement/Facile/classement15x15.txt")
		self.set_sensitive(true)
	}
