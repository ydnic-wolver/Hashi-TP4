##
# Cette classe représente l'interface des Classements de niveaux Moyen
##
require 'gtk3'
...
class ClassementMoyen < Gtk::Window
	...
	btnNiveau1.signal_connect('clicked'){
		...
		classement = ClassementNiveau.new("Classement/Moyen/classement7x7.txt")
		self.set_sensitive(true)
	}
	btnNiveau2 = Gtk::Button.new(:label => 'Niveau 2')
	btnNiveau2.signal_connect('clicked'){
		self.set_sensitive(false)
		classement = ClassementNiveau.new("Classement/Moyen/classement8x8.txt")
		self.set_sensitive(true)
	}
	btnNiveau3 = Gtk::Button.new(:label => 'Niveau 3')
	btnNiveau3.signal_connect('clicked'){
		self.set_sensitive(false)
		classement = ClassementNiveau.new("Classement/Moyen/classement10x7.txt")
		self.set_sensitive(true)
	}
	btnNiveau4 = Gtk::Button.new(:label => 'Niveau 4')
	btnNiveau4.signal_connect('clicked'){
		self.set_sensitive(false)
		classement = ClassementNiveau.new("Classement/Moyen/classement10x10.txt")
		self.set_sensitive(true)
	}
