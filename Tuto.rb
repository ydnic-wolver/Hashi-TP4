...
class Tuto 
	...
	# @tutoriel    -> Variable contenant la fenetre du tutoriel
	# @box_tuto    -> Variable contenant les informations d'affichage de la zone de tutoriel
    # @btnGauche   -> Variable contenant le bouton pour revenir en arrière dans le tutoriel
    # @btnDroite   -> Variable contenant le bouton pour avancer dans le tutoriel
    # @img_tuto    -> Variable contenant l'image affichée sur le tutoriel.
